/* preProcessTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. preProcessTokenManager.java */
package preProcess;
...
public class preProcessTokenManager implements preProcessConstants {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 4:
                  ...
                  break;
               case 5:
                  if ((0x4000000400000000L & l) != 0L && kind > 7)
                     kind = 7;
                  break;
               case 13:
                  if ((0xffffffffffffdbffL & l) == 0L)
...
static final int[] jjnextStates = {
   15, 20, 1, 2, 3, 4, 5, 16, 17, 19, 23, 25, 
};
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public preProcessTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public preProcessTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
