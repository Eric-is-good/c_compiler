/* LexErrorTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. LexErrorTokenManager.java */
...
public class LexErrorTokenManager implements LexErrorConstants {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 4:
                  ...
                  break;
               case 5:
                  if ((0xfffffffeffffffffL & l) != 0L && kind > 57)
                     kind = 57;
                  break;
               case 6:
                  if (curChar != 48)
...
"\133", "\135", "\72", null, null, null, null, null, null, };
...
static final int[] jjnextStates = {
   13, 14, 16, 28, 29, 31, 32, 35, 36, 26, 12, 17, 24, 9, 25, 26, 
   7, 10, 9, 20, 22, 35, 36, 26, 3, 4, 
};
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public LexErrorTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public LexErrorTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
